...
export const feats: FeatData[] = [
  ...
  },
  {
    id: "artifista",
    name: "Artifista",
    description: "Você recebe aptidão prática para criação e avaliação de manufaturas.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { artisanAptitude: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "musico",
    name: "Músico",
    description: "Você domina apresentações para apoiar aliados e interações sociais.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { performer: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "habilidoso",
    name: "Habilidoso",
    description: "Você amplia suas competências com novas proficiências.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { skilled: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "vigoroso",
    name: "Vigoroso",
    description: "Você desenvolve resistência física acima da média.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { hardy: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "valentao-taverna",
    name: "Valentão de Taverna",
    description: "Você é especialista em combate de curta distância com pegada brutal.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { tavernBrawler: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "atacante-selvagem",
    name: "Atacante Selvagem",
    description: "Você aumenta a eficiência das suas rolagens de dano corpo a corpo.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { savageAttacker: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "iniciado-magia-clerigo",
    name: "Iniciado em Magia (Clérigo)",
    description: "Aprenda truques e magia de 1º círculo da lista de Clérigo.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { magicInitiateCleric: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "iniciado-magia-druida",
    name: "Iniciado em Magia (Druida)",
    description: "Aprenda truques e magia de 1º círculo da lista de Druida.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { magicInitiateDruid: true } },
    source: { book: "PHB 2024", page: 0 },
  },
  {
    id: "iniciado-magia-mago",
    name: "Iniciado em Magia (Mago)",
    description: "Aprenda truques e magia de 1º círculo da lista de Mago.",
    type: "origin",
    prerequisites: [],
    effects: { flags: { magicInitiateWizard: true } },
    source: { book: "PHB 2024", page: 0 },
  },
];
